package frameworks.slim.skins
{
	...
	public class ButtonSkin extends ButtonSkinBase
	{
		 ...
		 * Up skin
		 */
		[Embed(source="images/Button.png", scaleGridLeft="12", scaleGridRight="18", scaleGridTop="11", scaleGridBottom="14")]
		protected var upFace:Class;
		
		/**
		 * Down skin
		 */
		[Embed(source="images/ButtonDown.png", scaleGridLeft="12", scaleGridRight="18", scaleGridTop="11", scaleGridBottom="14")]
		protected var downFace:Class;
		
		/**
		 * @private
		 */
		[Embed('images/ButtonPattern.png')]
		private var patternFace:Class;
		
		/**
		 * @private
		 */
		private var patternBitmap:Bitmap = new patternFace();
		...
		{
			// Draw a stripe pattern
			graphics.clear();
			graphics.beginBitmapFill(patternBitmap.bitmapData);
			graphics.drawRoundRectComplex(5, 5, unscaledWidth - 10, unscaledHeight - 10, 5, 5, 5, 5);
			graphics.endFill();
		}
